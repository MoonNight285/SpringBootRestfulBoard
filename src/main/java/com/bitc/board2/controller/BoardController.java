...
// Client 가 자원의 상태에 대한 조작을 요청 시 서버는 이에 적잘한 응답을 보낸다.
...
public class BoardController {
    ...
    // 아래의 writeBoard()와 insertBoard() 메서드는 서로 매칭된 주소가 동일하지만 method의
    // 타입이 다르기 때문에 다르게 동작됨
    ...
    // RequestMapping : URI의 리소스가 매서드의 파라미터로 사용하는 어노테이션
    // RequestMapping의 value 값에 들어가는 경로의 변수명과 PathVariable의 변수명이 일치해야 작동
